Public Class ComprobanteCompraEntity
    ...
    Private _tipo_compra As String
    ...
    Private _serie_dua As String
    Private _numero_dua As String
    Private _anio_dua As Date
    ...
    Public Property serie_dua() As String
        Get
            Return _serie_dua
        End Get
        Set(ByVal value As String)
    ...
    Public Property anio_dua() As Date
        Get
            Return _anio_dua
        End Get
