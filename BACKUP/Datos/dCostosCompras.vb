...
Public Class dCostosCompras
    Inherits Conexion

    Public Function registrarCostoDeCompras(entiCV As CostoComprasEntity) As String
        ...
        Try
            With cmd
                ...
                .CommandText = "usp_registrarCostoDeCompras"
        ...
        End Try
    End Function
    Public Function registrarCostoDeComprasBD(entiCV As CostoComprasEntity, cadena As String) As String
