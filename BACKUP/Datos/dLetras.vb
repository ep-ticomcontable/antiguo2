...
Public Class dLetras
    ...
    Public Function registrarCanjeLetraBD(entiCV As CanjeLetraEntity, cadena As String) As String
        ...
        End Try
    End Function
    Public Function registrarAsientosLetrasBD(idComprobante As String, idLetra As String, tipo As String, descripcion As String, cuenta As String, debe As Decimal, haber As Decimal, fecha As Date, cadena As String) As String
        If cnBD.State = ConnectionState.Closed Then conectarBD(cadena)
        Dim miTran As SqlTransaction = cnBD.BeginTransaction
        cmd = New SqlCommand
        Try
