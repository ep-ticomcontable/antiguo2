...
Public Class frmNuevaCompra
    ...
    Private Sub cboImpuestos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboImpuestos.SelectedIndexChanged
        If iCarga = 1 Then
            If cboImpuestos.SelectedValue.ToString <> "0" Then
                ...
                dataPorc = objCrud.nCrudListar("select * from impuestos_sunat where id='" & cboImpuestos.SelectedValue.ToString & "'")
    ...
    Private Sub btnAgregarCuenta_Click(sender As Object, e As EventArgs) Handles btnAgregarCuenta.Click
        ...
        Else
            ...
            'mTotal = totalConIgv
            mTotal = txtTotalCompra.Text.Trim
        End If
    ...
    Private Sub btnCargarDatos_Click(sender As Object, e As EventArgs) Handles btnCargarDatos.Click
        ...
        Else
            ...
            Dim dt1 As DataTable = DirectCast(dgvOperaciones.DataSource, DataTable)
            Dim row1 As DataRow = dt1.NewRow()
            row1.Item(0) = txtCuentaP.Text.Trim
            row1.Item(1) = obtenerDatosCuenta(txtCuentaP.Text.Trim)
            row1.Item(2) = txtTotalCompra.Text.Trim
            row1.Item(3) = "0.00"
            row1.Item(4) = txtDescripcionPago.Text.Trim
            row1.Item(5) = "-"
            row1.Item(6) = "-"
            row1.Item(7) = "-"
            dt1.Rows.Add(row1)
    ...
    Private Sub cboPercepcion_SelectedIndexChanged_1(sender As Object, e As EventArgs) Handles cboPercepcion.SelectedIndexChanged
        If iCarga = 1 Then
            Dim dataPorc As New DataTable
            dataPorc = objCrud.nCrudListar("select * from impuestos_sunat where id='" & cboPercepcion.SelectedValue.ToString & "'")
            If dataPorc.Rows.Count > 0 Then
    ...
    Private Sub guardarDatos(estadoComprobante As String)
        ...
        For Each row As DataGridViewRow In dgvOperaciones.Rows
            ...
            End If
        Next
        If txtRazonSocial.Text.Trim.Length > 5 And txtRuc.Text.Trim.Length >= 8 Then
    ...
    Private Sub dgvOperaciones_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvOperaciones.CellContentClick
