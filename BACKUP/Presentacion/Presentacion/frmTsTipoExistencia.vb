...
Public Class frmTsTipoExistencia
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListar("select * from vista_tipo_existencia order by codigo asc")
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListar("select * from vista_tipo_existencia where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'")
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
