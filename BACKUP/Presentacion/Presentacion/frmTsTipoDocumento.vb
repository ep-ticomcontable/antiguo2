...
Public Class frmTsTipoDocumento
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListar("select * from vista_tipo_documento order by codigo asc")
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListar("select * from vista_tipo_documento where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'")
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
