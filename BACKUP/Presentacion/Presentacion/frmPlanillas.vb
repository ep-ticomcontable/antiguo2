...
Public Class frmPlanillas
    ...
    Private Sub btnFinalizar_Click(sender As Object, e As EventArgs) Handles btnFinalizar.Click
        ...
        dato = objPla.registrarCabeceraPlanillaBD(txtNumPlanilla.Text.Trim, txtGlosaPlanilla.Text.Trim, cboPeriodo.Text.ToString, cboMoneda.SelectedValue.ToString, txtTDebeS.Text.Trim, Date.Parse(dtFecha.Value), "FINALIZADO", "1", CadenaConexion)
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        Dim dato, dato2 As String
        dato = objPla.registrarCabeceraPlanillaBD(txtNumPlanilla.Text.Trim, txtGlosaPlanilla.Text.Trim, cboPeriodo.Text.ToString, cboMoneda.SelectedValue.ToString, txtTDebeS.Text.Trim, Date.Parse(dtFecha.Value), "GRABADO", "1", CadenaConexion)
        'MsgBox("REGISTRO PLANILLA: " & dato)
        If dato = "ok" Then
            Dim data As New DataTable
            data = objCrud.nCrudListarBD("select * from planillas where id='" & txtNumPlanilla.Text.Trim & "'", CadenaConexion)
