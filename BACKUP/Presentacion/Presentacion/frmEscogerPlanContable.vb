...
Public Class frmEscogerPlanContable
    ...
    Public Sub cargarDatosCuentaContable()
        ...
        dgvLista.DataSource = obj.nCrudListarBD("select * from vista_CuentaContableGrilla where num_cuenta like '" & cuentaInicio2digitos & "%' and nivel_cuenta='REGISTRO'  order by num_cuenta asc", CadenaConexion)
    End Sub
    ...
    Private Sub cargarDatosAAdicionAsientoApertura()
        If dgvLista.Rows.Count > 0 Then
            ...
            ElseIf formInicio = "frmAbonoDeudasLetras" Then
                ...
                frmAbonoDeudasLetrasACobrar.lblNomCuenta.Text = dgvLista.Rows(f).Cells("nombre").Value.ToString.ToUpper
