...
Public Class frmListaAperturas
    ...
    Public Sub cabeceraApertura()
        ...
        data = objCrud.nCrudListarBD("select id as 'numero',glosa as 'descripcion',total_debe_s as 't_debe',total_haber_s as 't_haber',fecha,estado from asiento_apertura order by fecha desc", CadenaConexion)
    ...
    Private Sub cargarDetalle()
        ...
        End If
        Dim data As New DataTable
        data = objCrud.nCrudListarBD("select d.cuenta as 'num_cuenta',c.nombre as 'desc_cuenta',d.debe,d.haber,d.glosa from detalle_asiento_apertura d inner join cuenta_contable c on d.cuenta=c.id  where d.id_asiento_apertura='" & idComprobante & "'", CadenaConexion)
