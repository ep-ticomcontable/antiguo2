...
Public Class frmExcel
    ...
    Private Sub frmExcel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        dgvLista.DataSource = obj.nCrudListar("select * from asientos_libro_diario order by id asc")
    ...
    Private Sub generarExcel()
        ...
        Try
            ...
            tbDatos = obj.nCrudListar("select * from asientos_libro_diario order by id asc")
            ...
            a.Visible = True
            Archivo = "D:\excel\formato.5.1.xlsx" 'Pon aqui el nombre de archivo que quieras
    ...
    Private Sub generarExcelVentas()
        ...
        Try
            ...
            Dim tbDatos As New DataTable
            tbDatos = obj.nCrudListar("select * from comprobante_venta")
            ...
            a = CreateObject("Excel.Application")
            a.Visible = True
            Archivo = "D:\excel\formato.14.1.xlsx" 'Pon aqui el nombre de archivo que quieras
            APrueba = a.Workbooks.Open(Archivo)
            With APrueba.WorkSheets("formato")
