...
Public Class frmTsEntidadFinanciera
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListar("select * from vista_entidad_financiera order by codigo asc")
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListar("select * from vista_entidad_financiera where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'")
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
