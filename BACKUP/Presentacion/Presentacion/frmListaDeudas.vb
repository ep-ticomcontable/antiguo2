...
Public Class frmListaDeudas
    ...
    Private Sub cargarComprobantes()
        Dim data As New DataTable
        data = obj.nCrudListarBD("select * from comprobante_venta where tipo_venta='CREDITO' order by fec_emision asc", CadenaConexion)
    ...
    Private Sub btnGenerarNota_Click(sender As Object, e As EventArgs) Handles btnGenerarNota.Click
        If iCarga = 1 Then
            ...
            With frmPagoDeudas
                .Text = "Pago de Comprobante - N° registro: " & idComprobante
