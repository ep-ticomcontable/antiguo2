...
Public Class frmModificarCompraP
    ...
    Private Sub guardarDatos(estadoComprobante As String)
        ...
        With entiCCompra
            ...
            .marca = IIf(cboTipoCompra.SelectedValue = "CREDITO", cboPercepcion.Text & "@" & IIf(cboPercepcion.Text = "SIN AFECTO", "0", cboTipoPercepcion.SelectedValue), cboTipoPercepcion.Text & "@I")
    ...
    Private Sub cboPercepcion_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboPercepcion.SelectedIndexChanged
        If iCarga = 1 Then
            ...
            dataPorc = objCrud.nCrudListar("select * from impuestos_sunat where tipo_comprobante='COMPRA' and  id='" & cboPercepcion.SelectedValue.ToString & "'")
