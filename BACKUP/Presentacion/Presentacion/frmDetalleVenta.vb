...
Public Class frmDetalleVenta
    ...
    Public Sub cargarDatosCompra()
        ...
        data = objCrud.nCrudListarBD("select * from comprobante_compra where id='" & idVenta & "'", CadenaConexion)
        ...
        With data
            ...
            asientos = objCrud.nCrudListarBD("select * from asientos_comprobante_compra where id_comprobante_compra='" & idVenta & "'", CadenaConexion)
    ...
    Private Sub cboSerieImpuesto_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSerieImpuesto.SelectedIndexChanged
        ...
        End If
    End Sub
    Private Sub btnAgregarCuenta_Click(sender As Object, e As EventArgs)
        Dim dtData As New DataTable
        With dtData.Columns
            .Add("num_cuenta")
            .Add("desc_cuenta")
    ...
    Private Sub btnCargarDatos_Click(sender As Object, e As EventArgs)
        ...
        realizarSumasTotales()
    End Sub
    Private Sub btnVentana_Click(sender As Object, e As EventArgs)
