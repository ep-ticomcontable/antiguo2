...
Public Class frmTsImpuestosSunat
    ...
    Private Sub cargarDatos()
        Dim data As New DataTable
        data = obj.nCrudListar("select * from vista_datosImpuestosSunat order by tipo_comprobante asc")
    ...
    Private Sub cargarDatosCuenta()
        If tipo <> "new" Or tipo = "" Then
            ...
            With data
                ...
                dataCuenta = obj.nCrudListar("select * from cuenta_contable where id='" & .Rows(0)("cuenta").ToString & "'")
