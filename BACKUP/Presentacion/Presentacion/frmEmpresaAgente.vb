...
Public Class frmEmpresaAgente
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListar("select * from vista_tipo_moneda order by codigo asc")
    ...
    Private Sub cargarDatosCuenta()
        If tipo <> "new" Or tipo = "" Then
            ...
            Dim sql As String
            sql = "select * from tipo_moneda where id=" & codigoCeldaSeleccionada()
            Dim data As New DataTable
            data = obj.nCrudListar(sql)
            With data
                txtPorcentaje.Text = .Rows(0)("codigo")
                'txtDescripcion.Text = .Rows(0)("descripcion")
                'txtPais.Text = .Rows(0)("pais")
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListar("select * from vista_tipo_moneda where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'")
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Else
            estado = "1"
        End If
        campos = "codigo@descripcion@pais@estado"
        'valores = txtCodigo.Text.ToString & "@" & txtDescripcion.Text.ToString & "@" & txtPais.Text.ToString & "@" & estado
        Dim rpta As String = ""
        Dim tabla As String = "tipo_moneda"
        If tipo = "update" Then
    ...
    Private Sub gbGrupo_Enter(sender As Object, e As EventArgs) Handles gbGrupo.Enter
