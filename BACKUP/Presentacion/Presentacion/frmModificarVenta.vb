...
Public Class frmModificarVenta
    ...
    Public Sub cargarDatosCompra()
        ...
        With data
            ...
            asientos = objCrud.nCrudListarBD("select * from asientos_comprobante_venta where id_comprobante_venta='" & idVenta & "'", CadenaConexion)
    ...
    Private Sub guardarDatos(estadoComprobante As String)
        ...
        'dataCC = objCrud.nCrudListarBD("select * from comprobante_venta order by id desc", CadenaConexion)
        ...
        'Dim rpta As String = objCrud.nCrudActualizarBD("@", "comprobante_venta", "estado_comprobante", "F", "id='" & idVenta & "'", CadenaConexion)
