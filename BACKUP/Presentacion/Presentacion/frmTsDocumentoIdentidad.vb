...
Public Class frmTsDocumentoIdentidad
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListar("select * from vista_tipo_documento_identidad order by codigo asc")
    ...
    Private Sub cargarDatosCuenta()
        If tipo <> "new" Or tipo = "" Then
            ...
            Dim sql As String
            sql = "select * from tipo_documento_identidad where id=" & codigoCeldaSeleccionada()
            Dim data As New DataTable
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListar("select * from vista_tipo_documento_identidad where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'")
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Dim rpta As String = ""
        Dim tabla As String = "tipo_documento_identidad"
        If tipo = "update" Then
