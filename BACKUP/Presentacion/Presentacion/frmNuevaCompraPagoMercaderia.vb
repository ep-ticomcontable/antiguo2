...
Public Class frmNuevaCompraPagoMercaderia
    ...
    Private Sub btnCargar_Click(sender As Object, e As EventArgs) Handles btnCargar.Click
        ...
        Else
            ...
            glosaImpuesto = "DETRACCIÓN N°: " & frmNuevaCompraMercaderias.txtNumeroImpuesto.Text.Trim
            If idCaja <> "1" Then
    ...
    Private Sub guardarDatos(estadoComprobante As String)
        ...
        Else
            ...
            If frmNuevaCompraMercaderias.cboImpuesto.SelectedValue <> 0 Then
                ...
                dataPorc = objCrud.nCrudListar("select * from impuestos_sunat where tipo_comprobante='COMPRA' and id='" & frmNuevaCompraMercaderias.cboImpuesto.SelectedValue.ToString & "'")
                ...
                For Each row As DataGridViewRow In frmNuevaCompraMercaderias.dgvOperaciones.Rows
                    If dataPorc.Rows(0)("cuenta").ToString = row.Cells("num_cuenta").Value.ToString Then
                        With entiImpuesto
                            ...
                            .numero = frmNuevaCompraMercaderias.txtNumeroImpuesto.Text.Trim
            ...
            With entiCCompraAsiento
                ...
                .numero_detraccion = frmNuevaCompraMercaderias.txtNumeroImpuesto.Text.Trim
        ...
        If frmNuevaCompraMercaderias.cboImpuesto.SelectedValue = 0 Then
            ...
            For Each row As DataGridViewRow In dgvOperaciones.Rows
                With EntiAsientoAboCom
                    ...
                    .nro_detraccion = frmNuevaCompraMercaderias.txtNumeroImpuesto.Text.Trim
