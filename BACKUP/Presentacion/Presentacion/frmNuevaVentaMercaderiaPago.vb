...
Public Class frmNuevaVentaMercaderiaPago
    ...
    Private Sub guardarDatos(estadoComprobante As String)
        ...
        Else
            ...
            '    dataPorc = objCrud.nCrudListar("select * from impuestos_sunat where tipo_comprobante='VENTA' and id='" & frmNuevaVentaMercaderias.cboPercepcion.SelectedValue.ToString & "'")
