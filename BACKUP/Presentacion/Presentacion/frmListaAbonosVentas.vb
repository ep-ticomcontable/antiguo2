Imports Negocio
Public Class frmListaAbonosVentas
    ...
    Private Sub cargarPagos()
        ...
        data = objCrud.nCrudListarBD("select id,tipo,descripcion,monto,fecha from abono_pagos_ventas where id_venta='" & idComprobante & "' order by fecha asc", CadenaConexion)
