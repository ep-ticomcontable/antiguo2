...
Public Class frmListaNotasCreditos
    ...
    Private Sub generarExcelCompras()
        ...
        Try
            ...
            tbDatos = obj.nCrudListar("select * from comprobante_compra")
            ...
            With APrueba.WorkSheets("formato")
                ...
                For i As Integer = 0 To trKardex - 1
                    ...
                    If tbDatos.Rows(i)("fec_comp_origen").ToString <> "" Then
                        ...
                        Dim tc2 As DataTable = obj.nCrudListar("select * from tipo_documento where id='" & tbDatos.Rows(i)("tip_comp_origen").ToString & "'")
