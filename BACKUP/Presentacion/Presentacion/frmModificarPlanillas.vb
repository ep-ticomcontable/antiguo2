...
Public Class frmModificarPlanillas
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        dato = objPla.actualizarCabeceraPlanillaBD(txtNumPlanilla.Text.Trim, txtGlosaPlanilla.Text.Trim, cboPeriodo.Text.ToString, cboMoneda.SelectedValue.ToString, txtTDebeS.Text.Trim, Date.Parse(dtFecha.Value), "GRABADO", "1", CadenaConexion)
