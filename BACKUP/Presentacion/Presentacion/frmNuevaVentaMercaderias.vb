...
Public Class frmNuevaVentaMercaderias
    ...
    Private Sub agregarCuentaContable()
        ...
        cuentas.Rows.Add(dataIgv.Rows(0)("cuenta").ToString, obtenerDatosCuenta(dataIgv.Rows(0)("cuenta").ToString), "0.00", Decimal.Round(Decimal.Parse(txtTotalVenta.Text.Trim - monto), 2), txtGlosa.Text.Trim)
    ...
    Private Sub cboImpuesto_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboImpuesto.SelectedIndexChanged
        If iCarga = 1 Then
            Dim dataPorc As New DataTable
            dataPorc = objCrud.nCrudListar("select * from impuestos_sunat where tipo_comprobante='VENTA' and  id='" & cboImpuesto.SelectedValue.ToString & "'")
            If dataPorc.Rows.Count > 0 Then
                txtPorcPercep.Text = dataPorc.Rows(0)("porcentaje").ToString
            Else
                txtPorcPercep.Text = "0"
