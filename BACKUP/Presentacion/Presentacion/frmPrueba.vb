...
Public Class frmPrueba
    ...
    Private Sub copiarBD()
        ...
        Dim fileMdf As String = "D:\BDS\TICOM-CONTABLE.mdf"
        ...
        Dim fileLdf As String = "D:\BDS\TICOM-CONTABLE_log.ldf"
        My.Computer.FileSystem.CopyFile(
            fileLdf,
    ...
    Private Sub cboBd_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboBd.SelectedIndexChanged
        If carga = 1 Then
            ...
            'dgvLista.DataSource = Nothing
            'dgvLista.DataSource = objCrud.nCrudListar("select * from [" & cboBd.SelectedValue.ToString & "].dbo.cuenta_contable order by id asc")
        End If
    End Sub
End Class