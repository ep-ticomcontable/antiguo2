...
Public Class frmPagoComprobanteCompraRapida
    ...
    Private Sub cargarDatosDeDatatableVenta()
        ...
        'dataCab = objCrud.nCrudListar("select * from asiento_cuentas_cabecera where asiento='COMPRA' order by orden asc")
        ...
        '    dt = objCrud.nCrudListar("select * from cuenta_contable where id='" & dtAsientoVenta.Rows(0)("num_cuenta").ToString & "'")
    ...
    Private Function obtenerDatosCuenta(cuenta As String) As String
        ...
        Dim dt As New DataTable
        dt = objCrud.nCrudListar("select * from cuenta_contable where id='" & cuenta & "'")
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        'dataPie = objCrud.nCrudListar("select * from asiento_cuentas_pie where asiento='COMPRA' order by orden asc")
