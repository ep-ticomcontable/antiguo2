...
Public Class frmEmpresaAgente
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListarBD("select * from vista_tipo_moneda order by codigo asc", CadenaConexion)
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListarBD("select * from vista_tipo_moneda where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'", CadenaConexion)
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
    ...
    Private Sub txtPorcentaje_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPorcentaje.Leave
        txtPorcentaje.Text = Format(CType(txtPorcentaje.Text, Decimal), "###0.00")
    End Sub
