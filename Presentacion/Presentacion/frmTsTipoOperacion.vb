...
Public Class frmTsTipoOperacion
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListarBD("select * from vista_tipo_operacion order by codigo asc", CadenaConexion)
    ...
    Private Sub cargarDatosCuenta()
        If tipo <> "new" Or tipo = "" Then
            ...
            Dim sql As String
            sql = "select * from tipo_operacion where id=" & codigoCeldaSeleccionada()
            Dim data As New DataTable
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListarBD("select * from vista_tipo_operacion where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'", CadenaConexion)
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Dim rpta As String = ""
        Dim tabla As String = "tipo_operacion"
        If tipo = "update" Then
