...
Public Class frmTsEntidadFinanciera
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListarBD("select * from vista_entidad_financiera order by codigo asc", CadenaConexion)
        dgvLista.DataSource = data
        data = Nothing
        cargaInicialEstados()
    End Sub

    Private Sub frmTsEntidadFinanciera_Load(sender As Object, e As EventArgs) Handles Me.Load
        cargarDatos()
        txtDato.Focus()
        txtDato.Select()
    End Sub
    ...
    Private Sub cargarDatosCuenta()
        If tipo <> "new" Or tipo = "" Then
            ...
            Dim sql As String
            sql = "select * from entidad_financiera where id=" & codigoCeldaSeleccionada()
            Dim data As New DataTable
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListarBD("select * from vista_entidad_financiera where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'", CadenaConexion)
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Dim rpta As String = ""
        Dim tabla As String = "entidad_financiera"
        If tipo = "update" Then
