...
Public Class frmListaCajaChica
    ...
    Private Sub cargarCaja()
        ...
        Dim data2 As DataTable
        Try
            data2 = obj.nCrudListarBD("select * from caja_configuracion where tipo='CHICA' and estado=1 order by id asc", CadenaConexion)
            For Each row As DataRow In data2.Rows
    ...
    Private Function querysPorCombinacion() As String
        ...
        query = "select * from vista_listaRegistrosCajaChica where 1=1 "
        If dCaja.Rows.Count > 0 Then
            query += "and cuenta<>'" & dCaja.Rows(0)("cuenta").ToString & "'"
        End If
    ...
    Private Sub frmListaComprobanteVentas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cargarPeriodos()
        iCarga = 1
        If cboCaja.SelectedValue <> 0 Then
            cargarComprobantes()
