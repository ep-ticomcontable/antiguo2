...
Public Class frmListaLetrasPorRevisar
    ...
    Private Sub cargarComprobantes()
        Dim data As New DataTable
        data = obj.nCrudListarBD("usp_listarDeudasPorCobrar", CadenaConexion)
    ...
    Private Sub btnPagarConLetra_Click(sender As Object, e As EventArgs) Handles btnPagarConLetra.Click
        If iCarga = 1 Then
            ...
            'With frmCanjeLetraComprobanteVenta
            '    .Text = "Canje de Comprobante por Letra"
