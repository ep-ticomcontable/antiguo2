...
Public Class frmTsAduana
    ...
    Private Sub cargarDatos()
        ...
        data = obj.nCrudListarBD("select * from vista_datosAduana order by codigo asc", CadenaConexion)
    ...
    Private Sub cargarDatosCuenta()
        If tipo <> "new" Or tipo = "" Then
            ...
            Dim sql As String
            sql = "select * from aduana where id=" & codigoCeldaSeleccionada()
            Dim data As New DataTable
    ...
    Private Sub txtDato_TextChanged(sender As Object, e As EventArgs) Handles txtDato.TextChanged
        ...
        data = obj.nCrudListarBD("select * from vista_datosAduana where descripcion like '%" & dato & "%' or codigo like '%" & dato & "%'", CadenaConexion)
        dgvLista.DataSource = data
        cargaInicialEstados()
        'End If
    End Sub
