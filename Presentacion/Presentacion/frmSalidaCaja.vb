...
Public Class frmSalidaCaja
    ...
    Private Sub realizarProceso()
        ...
        With entiCaja
            ...
            .id_tipo_salida = cboTipoPago.SelectedValue.ToString
            .id_documento = "1"
            .serie = "0"
    ...
    Private Sub cboCaja_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboCaja.SelectedIndexChanged
        If iCarga = 1 Then
            cargarTipoPagos(cboCaja.SelectedValue.ToString)
        End If
    End Sub
    ...
    Private Sub cboTipoPago_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboTipoPago.SelectedIndexChanged
        If iCarga = 1 Then
            If cboTipoPago.Text.ToString.StartsWith("CHEQ") Then
                frmGirarCheque.tipoAbono = "cajas"
                frmGirarCheque.valMoneda = cboMoneda.SelectedValue.ToString
