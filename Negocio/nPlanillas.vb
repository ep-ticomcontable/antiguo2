...
Public Class nPlanillas
    ...
    End Function
    Public Function registrarCabeceraPlanillaBD(id As Integer, glosa As String, periodo As String, moneda As String, total As Decimal, fecha As Date, tipo As String, estado As String, codEmpresa As Integer, cadena As String) As String
        Return obj.registrarCabeceraPlanillaBD(id, glosa, periodo, moneda, total, fecha, tipo, estado, codEmpresa, cadena)
    End Function
