...
Public Class nAbonosPagos
    ...
    Public Function nObtenerUltimoAbonoVentaBD(cadena As String) As String
        Return obj.obtenerUltimoAbonoVentaBD(cadena)
    End Function
    ...
    Public Function nRegistrarAsientoAbonoVentasBD(entiAA As AbonoComprasEntity, cadena As String) As String
        Return obj.registrarAsientoAbonoVentasBD(entiAA, cadena)
    End Function
